 ...
 */
public class FinalBoss extends Creature {

    private char charRepresentation = '*';
    private Image imgRepresentation = new Image("finalboss.png");
    private int health = 20;
    private int damage = 10;
    private int armor = 4;
    private String name = "Final Boss";

    public FinalBoss(int[] pos) {
        super(pos);
    }

    public FinalBoss(int[] pos, int health, int damage, int armor) {
