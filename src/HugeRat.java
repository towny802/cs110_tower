 ...
 */
public class HugeRat extends Creature {

    private char charRepresentation = '%';
    private Image imgRepresentation = new Image("hugerat.png");
    private int health = 13;
    private int damage = 3;
    private int armor = 1;
    private String name = "Huge Rat";

    public HugeRat(int[] pos) {
        super(pos);
    }

    public HugeRat(int[] pos, int health, int damage, int armor) {
