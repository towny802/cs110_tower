...
public class Kobold extends Creature {
    ...
    private Image imgRepresentation = new Image("kobold.png");
    private int health = 10;
    private int damage = 3;
    private int armor = 2;
    private String name = "Kobold";

    public Kobold(int[] pos) {
        super(pos);
    }

    public Kobold(int[] pos, int health, int damage, int armor) {
