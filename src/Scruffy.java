 ...
 */
public class Scruffy extends Creature {

    private char charRepresentation = 'Y';
    private Image imgRepresentation = new Image("scruffy.png");
    private int health = 15;
    private int damage = 6;
    private int armor = 2;
    private String name = "Scruffy";

    public Scruffy(int[] pos) {
        super(pos);
    }

    public Scruffy(int[] pos, int health, int damage, int armor) {
