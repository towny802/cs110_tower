...
public class Assassin extends Creature {
    ...
    private char charRepresentation = 'a';
    private Image imgRepresentation = new Image("assassin.png");
    private int health = 15;
    private int damage = 5;
    private int armor = 1;
    private String name = "Assassin";

    public Assassin(int[] pos) {
        super(pos);
    }

    public Assassin(int[] pos, int health, int damage, int armor) {
